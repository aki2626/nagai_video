...
### データ通信量がより増加していく現在、あらゆるWebアプリケーションで文字や画像データだけでなく、動画やライブ映像を取り扱いだすのではと思い、このアプリを作成しました。<br>数ある動画の中からユーザーが求めている動画を検索しやすく、使いやすいと思ってもらえるよう工夫しました。具体的にはトップページからジャンル、キーワード、タグ検索を行えるようにし、ランキングや新着動画を表示をするように工夫を施しました。
